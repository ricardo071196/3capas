    ...
    public class EquipoADO
    {
        ...
        public Boolean InsertarEquipo(EquipoBE objEquipoBE)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Cantidad", objEquipoBE.Cantidad);
                ...
                cmd.Parameters.AddWithValue("@proveedor", objEquipoBE.Proveedor);
                cmd.Parameters.AddWithValue("@ruc", objEquipoBE.Ruc);
                cmd.Parameters.AddWithValue("@telefono", objEquipoBE.Telefono);
                cmd.Parameters.AddWithValue("@Fecha_partida", objEquipoBE.Fecha_partida);
                cmd.Parameters.AddWithValue("@Fec_registro", objEquipoBE.Fec_registro);
